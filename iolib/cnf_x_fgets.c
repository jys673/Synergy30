/*====================================================================*/
/*  Subroutine   cnf_xdr_fgets()    				      */ 
/*	cnf_xdr_fgets() - read the external data representation of    */
/*	a line from file into buffer (starting at address xdr_buff)   */
/*	and Translates it to C language. RETURNS: 0 on EOF, o/w       */
...
int cnf_xdr_fgets(id, buf, bufsize, e_type)
int id;
char *buf;
int bufsize;
int e_type;
{
        ...
        status = cnf_fgets(id, buf, bufsize);
